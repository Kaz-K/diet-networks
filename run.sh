...
~/.pyenv/versions/anaconda3-5.2.0/envs/pytorch/bin/python visualize_emb.py -c config/comp_architectures/diet_recon_0.001.json
...
~/.pyenv/versions/anaconda3-5.2.0/envs/pytorch/bin/python visualize_emb.py -c config/comp_architectures/diet_fs_0.001.json
